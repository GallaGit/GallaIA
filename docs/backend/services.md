...
- Active: Template instantiate + goal orchestrator stub (`app/services/goals.py`) + signed webhook (`app/services/triggers.py`).
- Future: RAG, product-chat orchestration, cron automations, Ripples.
